...
$font-family-monospace    = 'Fira Code', consolas, Menlo, monospace, $font-family-chinese;
$font-family-monospace    = 'Fira Code', get_font_family('codes'), consolas, Menlo, monospace, $font-family-chinese if get_font_family('codes');
